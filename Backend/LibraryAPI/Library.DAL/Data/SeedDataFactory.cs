    ...
    internal static class SeedDataFactory
    {
        ...
        internal static void SeedData(ModelBuilder builder)
        {
            ...
            builder.Entity<Author>().HasData(
                ...
                new Author { Id = 3, FullName = "Steve T. Beckett" },
                new Author { Id = 4, FullName = "Ward Chesworth" },
                new Author { Id = 5, FullName = "Hans Moravec" },
                new Author { Id = 6, FullName = "Carlo Rovelli" },
                new Author { Id = 7, FullName = "Francesca Vidotto" },
                new Author { Id = 8, FullName = "Abhijit R. Satoskar" },
                new Author { Id = 9, FullName = "Gary L. Simon" },
                new Author { Id = 10, FullName = "Peter J. Hotez" },
                new Author { Id = 11, FullName = "Moriya Tsuji" },
                new Author { Id = 12, FullName = "George Dyson" },
                new Author { Id = 13, FullName = "Charles Darwin" },
                new Author { Id = 14, FullName = "Floyd James Rutherford" },
                new Author { Id = 15, FullName = "Andrew Ahlgren" },
                new Author { Id = 16, FullName = "Nikolai V. Gogol" },
                new Author { Id = 17, FullName = "Thucydides" },
                new Author { Id = 18, FullName = "Knut Hamsun" },
                new Author { Id = 19, FullName = "Oscar Wilde" },
                new Author { Id = 20, FullName = "Mary Shelley" },
                new Author { Id = 21, FullName = "Virginia Woolf" },
                new Author { Id = 22, FullName = "Bruno Schulz" },
                new Author { Id = 23, FullName = "Lee Child" },
                new Author { Id = 24, FullName = "James Joyce" },
                new Author { Id = 25, FullName = "Virginia Woolf" },
                new Author { Id = 26, FullName = "Jude Deveraux" },
                new Author { Id = 27, FullName = "Arnett Lamb" },
                new Author { Id = 28, FullName = "Jill Barnett" },
                new Author { Id = 29, FullName = "Judith McNaught" },
                new Author { Id = 30, FullName = "Charlotte Brontë" },
                new Author { Id = 31, FullName = "Jane Austen" },
                new Author { Id = 32, FullName = "Julie Garwood" },
                new Author { Id = 33, FullName = "Jojo Moyes" },
                new Author { Id = 34, FullName = "Danielle Steel" },
                new Author { Id = 35, FullName = "Santa Montefiore" },
                new Author { Id = 36, FullName = "Johanna Lindsey" },
                new Author { Id = 37, FullName = "C. S. Lewis" },
                new Author { Id = 38, FullName = "Ursula K. Le Guin" },
                new Author { Id = 39, FullName = "Tove Jansson" },
                new Author { Id = 40, FullName = "J. R. R. Tolkien" },
                new Author { Id = 41, FullName = "John Ronald Reuel Tolkien" },
                new Author { Id = 42, FullName = "Lewis Carroll" },
                new Author { Id = 43, FullName = "Clive Staples Lewis" },
                new Author { Id = 44, FullName = "L. Frank Baum" },
                new Author { Id = 45, FullName = "Kenneth Graham" },
                new Author { Id = 46, FullName = "Tracy Deonn" },
                new Author { Id = 47, FullName = "Agatha Christie" },
                new Author { Id = 48, FullName = "Dan Brown" },
                new Author { Id = 49, FullName = "Mark Haddon" },
                new Author { Id = 50, FullName = "P. D. James" },
                new Author { Id = 51, FullName = "Fyodor Dostoevsky" },
                new Author { Id = 52, FullName = "Fred Vargas" },
                new Author { Id = 53, FullName = "Josephine Tey" },
                new Author { Id = 54, FullName = "Kate Morton" },
                new Author { Id = 55, FullName = "C. S. Lewis" },
                new Author { Id = 56, FullName = "Philip Freeman" },
                new Author { Id = 57, FullName = "E. J. F. Kəppi" },
                new Author { Id = 58, FullName = "Helen S. Rountree" },
                new Author { Id = 59, FullName = "Carl Baxson" },
                new Author { Id = 60, FullName = "Jerry Z. Müller" },
                new Author { Id = 61, FullName = "Jonathan Harris" },
                new Author { Id = 62, FullName = "Serhii Plokhii" },
                new Author { Id = 63, FullName = "G. N. Dewi" },
                new Author { Id = 64, FullName = "Jeffrey W. Davis" },
                new Author { Id = 65, FullName = "K. K. Chakravarti" },
                new Author { Id = 66, FullName = "Vahan M. Kyurkchyan" },
                new Author { Id = 67, FullName = "Victor E. Torren" },
                new Author { Id = 68, FullName = "John Robert Christianson" },
                new Author { Id = 69, FullName = "William Smith" },
                new Author { Id = 70, FullName = "Elizabeth Gilbert" },
                new Author { Id = 71, FullName = "Primo Levi" },
                new Author { Id = 72, FullName = "Charles Knight" },
                new Author { Id = 73, FullName = "Desmond Shum" },
                new Author { Id = 74, FullName = "John Alexander Gay" },
                new Author { Id = 75, FullName = "Richard A. Barrage" },
                new Author { Id = 76, FullName = "Plutarch" },
                new Author { Id = 77, FullName = "John Langhorn" },
                new Author { Id = 78, FullName = "William Langhorn" },
                new Author { Id = 79, FullName = "Lance Day" },
                new Author { Id = 80, FullName = "Ian McNail" },
                new Author { Id = 81, FullName = "Floyd James Rutherford" },
                new Author { Id = 82, FullName = "Andrew Ahlgren" },
                new Author { Id = 83, FullName = "Mitchell Resnick" },
                new Author { Id = 84, FullName = "Andrew Feinberg" },
                new Author { Id = 85, FullName = "Steven Graham" },
                new Author { Id = 86, FullName = "Simon Marvin" },
                new Author { Id = 87, FullName = "Hannah Arendt" },
                new Author { Id = 88, FullName = "Oliver Manuel" },
                new Author { Id = 89, FullName = "Fritz Ulman" },
                new Author { Id = 90, FullName = "Leo Marx" },
                new Author { Id = 91, FullName = "Wolfgang Gehhartz" },
                new Author { Id = 92, FullName = "John Dewey" },
                new Author { Id = 93, FullName = "Jean Giono" },
                new Author { Id = 94, FullName = "Robert Burr" },
                new Author { Id = 95, FullName = "Mary Ellen Miller" },
                new Author { Id = 96, FullName = "Simon Martin" },
                new Author { Id = 97, FullName = "Martin Kemp" },
                new Author { Id = 98, FullName = "Guy Debord" },
                new Author { Id = 99, FullName = "Gogol Google Translate" },
                new Author { Id = 100, FullName = "Vahan M. Kyurkchyan" },
                new Author { Id = 101, FullName = "George Bernard Shaw" },
                new Author { Id = 102, FullName = "Jane Portal" },
                new Author { Id = 103, FullName = "Tom Masters" },
                new Author { Id = 104, FullName = "Orhan Pamuk" },
                new Author { Id = 105, FullName = "Konrad Joseph" },
                new Author { Id = 106, FullName = "Tom Stone" },
                new Author { Id = 107, FullName = "Eric Solsten" },
                new Author { Id = 108, FullName = "Elizabeth Gilbert" },
                new Author { Id = 109, FullName = "Tony Whitten" },
                new Author { Id = 110, FullName = "Rohayat Emon Sueriatmaja" },
                new Author { Id = 111, FullName = "Suraiya A. Afif" },
                new Author { Id = 112, FullName = "Francis Moroney" },
                new Author { Id = 113, FullName = "Paul F. J. Igles" },
